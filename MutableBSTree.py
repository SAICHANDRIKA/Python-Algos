...
# (I) now, make a *mutable* collection 
#           (and confirm that it's mutable -- give it to several different variables
#            and check that inserting to one makes the changes visible to the others)
#      How to make our code mutable, version 1: 
#          Simply make your tree be a list-of-exactly-1-immutableBST.
#          Wrap each top-level function (insert, delete, contains?) inside a function which
#          simply passes the real BSTree to the real function (and uses the result to re-assign).]
         
#       Repeat the measurements from (0), for your version (I).


# Mutable insert function

ls= [(50,(40,mt,mt,1),mt,2)]
l=ls
def mutable_insert_v2(t,n):
    return insert_v2(t[0],n)
     
ls[0]=mutable_insert_v2(ls,88)
ls[0]=mutable_insert_v2(ls,12)
ls[0]=mutable_insert_v2(ls,90)
# print("After inserting 88, 12 and 90 ls is ",ls)
# print("After inserting 88, 12 and 90 l is  ",l)
assert ls == l

# Mutable delete function

def mutable_delete_v2(t,n):
    return delete_v2(t[0],n)
ls[0] = mutable_delete_v2(ls,40)
ls[0] = mutable_delete_v2(ls,12)
# print("After deleting 40 and 12, ls is ",ls)
# print("After deletion 40 and 12, l is ",l)
assert ls == l
...
def measure_BStreePerformance(num_inserts):
    ...
    for j in num_inserts:
        ...
        for k in random_list:
            mutableBStree[0] = mutable_insert_v2(mutableBStree,k)
...
plt.title('Performance Measure of HeightCachedMutableBSTree', loc='Center', fontsize=14)
plt.show()

# Testing outputs 
# HeightCachedBSTree [2,4,8,16,32,64,128,256] inserts output [4000, 7000, 21000, 51000, 119000, 286000, 742000, 1423000]
# MutableBSTree [2,4,8,16,32,64,128,256] inserts output [5000, 8000, 22000, 50000, 119000, 327000, 702000, 1395000]
