...
def insert_v2( t, n ):
  ...
  if isEmpty(t):
    ...
    if val(t) < n:
      return balance((val(t),left(t),insert_v2(right(t),n)))
    else:
      return balance((val(t),insert_v2(left(t),n),right(t)))
...
plt.title('Performance Measure of BSTree', loc='Center', fontsize=14)
plt.show()
